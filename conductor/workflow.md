...
8. **Commit Code Changes:**
   ...
   - **Step 8.1: Draft Commit Message:** Create a detailed summary for the completed task. This should include the task name, a summary of changes, a list of all created/modified files, and the core "why" for the change.
   - **Step 8.2: Perform Commit:** Commit changes with the drafted message.
...
6.  **Create Checkpoint Commit:**
    -   Stage all changes.
    -   **Step 6.1: Draft Checkpoint Message:** Create a detailed verification report including the automated test command, the manual verification steps, and the user's confirmation.
    -   **Step 6.2: Perform Commit:** Commit this change with the drafted message following the format `conductor(checkpoint): Checkpoint end of Phase X`.
