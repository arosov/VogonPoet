...
* **Supported targets:** Desktop / JVM
* **Goal:** Maximize code sharing across platforms (e.g., JVM) using `commonMain`, `commonTest`, and platform-specific source sets (`androidMain`, `iosMain`, `jvmMain`, `wasmJsMain`, etc.).
